...
제24조(재판권 및 준거법)
 ...
 ②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
            ...
            <tr>
              <td>
                <input type="checkbox" id='checkbox1'>이용약관에 동의합니다.<br><br><br><br>
              </td>
            </tr>
            <tr>
              <td>
...
'정보통신망 이용촉진 및 정보보호 등에 관한 법률'의 거래기록 보존 의무에 따른 보존: 1년
            ...
            <tr>
              <td>
                <input type="checkbox" id='checkbox2'>개인정보 수집 및 이용에 대한 안내에 동의합니다.
              </td>
            </tr>
          </table>
...
<br><br>
  <a href="javascript:click();"> <button type = "button"  class="btn_order" style="margin:10px;">회 원 가 입</button></a>
  <a href="../templet/main.jsp"> <button type = "button"  class="btn_cancel1" style="margin:10px;">취 소 하 기</button></a>
